...
It’s people like you that make nem2-docs such a great tool.

nem2-docs is an open source project and we love to receive contributions from 
...
writing code which can be incorporated into nem2-docs itself.
...
If you think you have found a bug in nem2-docs, first make sure that you 
...
If you find yourself wishing for a feature that doesn't exist in nem2-docs, 
you are probably not alone. There are bound to be others out there with similar 
needs. Many of the features that nem2-docs has today have been added because 
...
You will need to fork the main nem2-docs code or documentation repository and clone 
...
Then sit back and wait. There will probably be discussion about the pull request and, if any changes are needed, we would love to work with you to get your pull request merged into nem2-docs.
