...
The `network <https://docs.symbol.dev/guides/network/configuring-network-properties.html>`__ and `node <https://docs.symbol.dev/guides/network/configuring-node-properties.html>`__ pages contain `static HTML snippets <https://github.com/symbol/symbol-docs/tree/main/source/_static>`__ autogenerated from the Catapult source code and Bootstrap's config files.

The generation code is in the `catapult-docs-cli <https://github.com/symbol/symbol-docs/tree/main/catapult-docs-cli>`__ repository and you will need to use the ``properties`` command.

`The README <https://github.com/symbol/symbol-docs/blob/main/catapult-docs-cli/README.md>`__ already contains a section on how to generate these tables.
...
The `serialization <https://docs.symbol.dev/serialization/index.html>`__ tables are also autogenerated using the `catapult-docs-cli <https://github.com/symbol/symbol-docs/tree/main/catapult-docs-cli>`__ repository, using the ``serialization`` command.
