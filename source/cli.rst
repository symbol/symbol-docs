...
.. code-block:: bash
    ...
    symbol-cli profile import --private-key <PRIVATE_KEY> --network TEST_NET --url http://api-02.ap-northeast-1.0941-v1.symboldev.network:3000 --password <PASSWORD> --profile <PROFILE_NAME>
...
.. code-block:: bash
    ...
    symbol-cli account generate --network TEST_NET --url http://api-02.ap-northeast-1.0941-v1.symboldev.network:3000 --password <PASSWORD> --profile <PROFILE_NAME> --save
