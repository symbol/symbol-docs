...
If you think you have found an error in nem2-docs, first make sure that you are testing against the latest version of nem2-docs - your issue may already have been fixed. If not, search our issues list on GitHub in case a similar
...
You will need to fork the main |repository| and clone it to your local machine. See |github-help| page for help.
...
.. |contributing-md| raw:: html
   ...
   <a href="https://github.com/nemtech/nem2-docs/blob/master/CONTRIBUTING.md/" target="_blank">CONTRIBUTING.md</a>
