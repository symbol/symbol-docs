...
Assuming that the :doc:`Catapult server<../../concepts/node>` Catapult server and :doc:`Catapult REST<../../concepts/node>` are :doc:`running locally<../guides/running-catapult-in-local>`, HTTP GET requests can be executed from a browser and have the form:
...
.. |endpoints-swagger| raw:: html
   ...
   <a href="https://github.com/nemtech/nem2-docs/blob/master/source/resources/collections/" target="_blank">Catapult REST API Endpoints Swagger</a>

.. |endpoints-insomnia| raw:: html

   <a href="https://github.com/nemtech/nem2-docs/blob/master/source/resources/collections/" target="_blank">Catapult REST API Endpoints Insomnia</a>
