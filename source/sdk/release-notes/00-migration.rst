...
NEM-SDK does not add features that are not 100% related to :doc:`Catapult REST API<../../api>`. Instead, it permits to be extended by the use of new standalone :doc:`libraries <../../sdk/libraries>`.
