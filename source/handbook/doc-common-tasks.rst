...
The `serialization <https://docs.symbol.dev/serialization/index.html>`__ tables are also autogenerated using the `catapult-docs-cli <https://github.com/symbol/catapult-docs-cli>`__ repository, using the ``serialization`` command.
