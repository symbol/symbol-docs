...
The `network configuration <https://github.com/nemtech/catapult-server/main/master/resources/config-network.properties>`_ also describes the initial and **maximum supply** of the native currency mosaic. The maximum supply takes into account the inflation generated per-block.
