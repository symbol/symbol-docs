...
const namespaceRegistrationTransaction = nem2_sdk_1.NamespaceRegistrationTransaction.createSubNamespace(nem2_sdk_1.Deadline.create(), subnamespaceName, rootNamespaceName, networkType).setMaxFee(2);
