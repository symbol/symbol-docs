...
var pageSize = 10; // Page size between 10 and 100, otherwise 10
accountHttp
    .getAccountTransactions(address, new nem2_sdk_1.QueryParams(pageSize))
    .subscribe(function (transactions) { return console.log(transactions); }, function (err) { return console.error(err); });
/* end block 01 */
