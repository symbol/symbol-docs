...
const aliceTransferTransaction = symbol_sdk_1.TransferTransaction.create(
  ...
  [symbol_sdk_1.NetworkCurrencyPublic.createRelative(1000)],
...
const bobTransferTransaction = symbol_sdk_1.TransferTransaction.create(
  ...
  [new symbol_sdk_1.Mosaic(new symbol_sdk_1.NamespaceId('collectible'), symbol_sdk_1.UInt64.fromUint(1))],
  symbol_sdk_1.PlainMessage.create('payout'),
  networkType,
);
...
const rectreatedAggregateTransactionFromPayload = symbol_sdk_1.TransactionMapping.createFromPayload(signedTransactionNotComplete.payload);
