...
/* start block 01 */
var privateKey = process.env.MULTISIG_ACCOUNT_PUBLIC_KEY;
var account = nem2_sdk_1.Account.createFromPrivateKey(privateKey, nem2_sdk_1.NetworkType.MIJIN_TEST);
var cosignatory1PublicKey = process.env.COSIGNATORY_1_PUBLIC_KEY;
var cosignatory1 = nem2_sdk_1.PublicAccount.createFromPublicKey(cosignatory1PublicKey, nem2_sdk_1.NetworkType.MIJIN_TEST);
var cosignatory2PublicKey = process.env.COSIGNATORY_2_PUBLIC_KEY;
var cosignatory2 = nem2_sdk_1.PublicAccount.createFromPublicKey(cosignatory2PublicKey, nem2_sdk_1.NetworkType.MIJIN_TEST);
/* end block 01 */
/* start block 02 */
var multisigAccountModificationTransaction = nem2_sdk_1.MultisigAccountModificationTransaction.create(nem2_sdk_1.Deadline.create(), 1, 1, [cosignatory1, cosignatory2], [], nem2_sdk_1.NetworkType.MIJIN_TEST);
/* end block 02 */
/* start block 03 */
var aggregateTransaction = nem2_sdk_1.AggregateTransaction.createBonded(nem2_sdk_1.Deadline.create(), [multisigAccountModificationTransaction.toAggregate(account.publicAccount)], nem2_sdk_1.NetworkType.MIJIN_TEST);
/* end block 03 */
/* start block 04 */
